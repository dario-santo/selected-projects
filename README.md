...
This repository collects a selection of projects developed during my academic and personal journey.
...
Designed and transformed data models across relational, graph (Neo4j), and document (MongoDB) databases, including process modeling with BPMN.
- [ER model + SQL queries](./EICTA_Project_1___ER_Model___SQL.pdf)
- [Neo4j + BPMN](./EICTA_Project_2___NEO4j___BPMN.pdf)
- [MongoDB](./EICTA_Project_3___MongoDB.pdf)
...
- **AI Governance in Healthcare (Sweden)**  
  Analyzed national AI and cybersecurity governance frameworks and policy design.  
  [View Project](./Sweden_Ai_Healthcare.pdf)

- **Maersk Cyber Attack (NotPetya)**  
  Analyzed a large-scale cyber incident, focusing on supply chain disruption and resilience strategies.  
  [View Project](./Maersk_Risk_Analysis.pdf)
